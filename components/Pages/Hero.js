...
const style = {
    ...
    gameButton: 'relative text-lg font-semibold px-14 py-4 bg-[#f51111] rounded-lg mr-5 text-black hover:bg-[#fb4848] border border-black hover:border-white cursor-pointer',
